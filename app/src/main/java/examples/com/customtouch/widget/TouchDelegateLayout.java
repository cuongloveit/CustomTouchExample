 ...
 */
package examples.com.customtouch.widget;
...
public class TouchDelegateLayout extends FrameLayout {
	...
	private CheckBox mButton1;
	private void init() {
		mButton = new CheckBox(getContext());
		mButton1 = new CheckBox(getContext());
		mButton.setText("Click Anywhere On Screen");
		mButton1.setText("Click Anywhere On Screen 1");

		addView(mButton, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, Gravity.CENTER));
		addView(mButton1, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, Gravity.TOP));
	}
